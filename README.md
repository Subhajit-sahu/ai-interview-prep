...
```bash
git clone https://github.com/Subhajit-sahu/ai-interview-prep.git
...
Replace the placeholder values with your actual **[Firebase](https://firebase.google.com/)**, **[Vapi](https://dashboard.vapi.ai/overview)** credentials.
